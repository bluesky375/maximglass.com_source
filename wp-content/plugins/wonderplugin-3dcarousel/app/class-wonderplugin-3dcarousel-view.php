...
class WonderPlugin_3DCarousel_View {
	...
	function add_metaboxes() {
		add_meta_box('overview_features', __('Wonder 3D Carousel Features', 'wonderplugin_3dcarousel'), array($this, 'show_features'), 'wonderplugin_3dcarousel_overview', 'features', '');
	...
	function print_overview() {
		...
		<h2><?php echo __( 'Wonder 3D Carousel', 'wonderplugin_3dcarousel' ) . ( (WONDERPLUGIN_3DCAROUSEL_VERSION_TYPE == "C") ? " Commercial Version" : " Free Version") . " " . WONDERPLUGIN_3DCAROUSEL_VERSION; ?> </h2>
