             ...
             <div class="pa-row">
                <table class="pa-beta-table">
                   ...
                   <tr class="pa-roll-row">
                      ...
                      <td>
                         <div><?php echo  sprintf( '<a target="_blank" href="%1$s" class="button pa-btn pa-rollback-button elementor-button-spinner">%2$s</a>', wp_nonce_url( admin_url( 'admin-post.php?action=premium_addons_rollback' ), 'premium_addons_rollback' ), __('Reinstall Version 3.4.1', 'premium-addons-for-elementor') ); ?></div>
